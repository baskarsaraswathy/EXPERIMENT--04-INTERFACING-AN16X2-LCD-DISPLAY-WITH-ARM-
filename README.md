#### Name : BASKAR  J
#### Reg no : 212223040025
# EXPERIMENT  04-INTERFACING AN16X2 LCDD ISPLAY WITH ARM AND DISPLAY STRING
...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,0);
  Lcd_string(&lcd, "BASKAR J\n");
  Lcd_cursor(&lcd, 1,2);
  Lcd_string(&lcd, "212223040025");
  HAL_Delay(500);
  while(1){}
}
void SystemClock_Config(void)
...
## Output screen shots of proteus  :
 ...
 ![WhatsApp Image 2024-04-02 at 16 13 42_cc387d99](https://github.com/baskarsaraswathy/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144871005/da94a8ba-a520-41ab-ac34-148c5291a0bc)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/baskarsaraswathy/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144871005/27d2273a-f09d-42f2-966d-44231c07bf6e)
